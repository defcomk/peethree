...
.method private constructor <init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lfxk;I)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Laxu;->c:Landroid/graphics/PointF;

    .line 3
    iput-object p2, p0, Laxu;->b:Landroid/graphics/PointF;

    .line 4
    iput-object p3, p0, Laxu;->e:Lfxk;
...
.method private final a(Landroid/graphics/PointF;Landroid/graphics/Rect;)Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    .line 25
    iget-object v1, p0, Laxu;->e:Lfxk;

    .line 26
    invoke-virtual {v1, p1}, Lfxk;->a(Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {v0, v2, v3}, Laxu;->a(III)I
...
.method public static a(Landroid/graphics/PointF;Landroid/graphics/PointF;ILfxm;)Laxu;
    .locals 4
    ...
    .line 10
    invoke-direct {v1, v3}, Lfxk;-><init>(I)V

    invoke-direct {v0, p0, p1, v1, v2}, Laxu;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lfxk;I)V
...
.method public static a(Landroid/graphics/PointF;Landroid/graphics/PointF;ILfxm;I)Laxu;
    .locals 4
    ...
    invoke-direct {v0, p0, p1, v1, p4}, Laxu;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lfxk;I)V
...
.method public final a(Landroid/graphics/Rect;)[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v2, p0, Laxu;->b:Landroid/graphics/PointF;

    invoke-direct {p0, v2, p1}, Laxu;->a(Landroid/graphics/PointF;Landroid/graphics/Rect;)Landroid/hardware/camera2/params/MeteringRectangle;
...
.method public final b(Landroid/graphics/Rect;)[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v2, p0, Laxu;->c:Landroid/graphics/PointF;
