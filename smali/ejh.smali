...
.field private final e:Lcmp;

.field private final f:Lkjq;


# direct methods
.method constructor <init>(Lkjq;Lkjm;Lcnj;Lcmp;Liue;Lktr;)V
    .locals 2
    ...
    .line 2
    iput-object p1, p0, Lejh;->f:Lkjq;

    .line 3
    iput-object p3, p0, Lejh;->b:Lcnj;

    .line 4
    iput-object p4, p0, Lejh;->e:Lcmp;

    .line 5
    iput-object p5, p0, Lejh;->a:Liue;

    .line 6
    invoke-interface {p6}, Lktr;->b()Lkuj;
...
.method private final a(Lgee;I)Ljava/util/HashMap;
    .locals 6
    ...
    .line 168
    :try_start_0
    invoke-interface {p1}, Lgee;->a()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lgef;
    :try_end_0
    .catch Lklk; {:try_start_0 .. :try_end_0} :catch_3
...
.method private final a(Lcom;IILgee;Ljava/util/HashMap;[Landroid/hardware/camera2/params/Face;)Lkxf;
    .locals 15

    .prologue
    .line 134
    iget-object v2, p0, Lejh;->f:Lkjq;
    ...
    .line 135
    :try_start_0
    invoke-interface/range {p4 .. p4}, Lgee;->a()Ljava/lang/Object;
    ...
    :cond_0
    :try_start_2
    invoke-virtual {v6}, Lgef;->close()V
    ...
    invoke-interface/range {v7 .. v13}, Lcnj;->a(Lcom;ILkxf;Lkxo;Lkxo;[Landroid/hardware/camera2/params/Face;)V
    :try_end_2
    ...
    .line 156
    invoke-interface {v3, v4, v2}, Lkjl;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v3, v2}, Lklk;-><init>(Ljava/lang/Throwable;)V
...
.method private final a(Lcom;IILkxf;)V
    .locals 7
...
.method private final a(Lcom;Lcom/google/googlex/gcam/FrameRequestVector;Lgoe;Lgce;Lgee;Lgee;Lgba;Lkix;Lhzz;[Landroid/hardware/camera2/params/Face;)Z
    .locals 14
    ...
    .line 33
    invoke-interface/range {p5 .. p5}, Lgee;->d()I
    ...
    .line 34
    invoke-virtual/range {p4 .. p5}, Lgce;->a(Lgbs;)Lgce;
    ...
    invoke-virtual {v0, v1}, Lgce;->a(Lgbs;)Lgce;

    .line 36
    :cond_0
    move-object/from16 v0, p3

    invoke-interface {v0, v10}, Lgoe;->a(I)Lkjd;

    move-result-object v2

    .line 37
    invoke-static {v2}, Lfqc;->c(Lkjd;)Lgcm;
    ...
    iget-boolean v3, p0, Lejh;->c:Z

    .line 44
    invoke-virtual {p0, v3}, Lejh;->a(Z)I
    ...
    .line 50
    iget-object v4, p0, Lejh;->e:Lcmp;

    move-object/from16 v0, p4

    invoke-virtual {v4, v2, v0}, Lcmp;->a(Lcom/google/googlex/gcam/FrameRequest;Lgce;)V
    ...
    invoke-direct {v2, v0}, Lgce;-><init>(Lgce;)V
    ...
    .line 58
    :cond_2
    iget-object v3, p0, Lejh;->e:Lcmp;

    move-object/from16 v0, p4

    invoke-virtual {v3, v12, v0}, Lcmp;->a(Lcom/google/googlex/gcam/FrameRequest;Lgce;)V
    ...
    invoke-interface {v0, v11, v2}, Lgba;->a(Ljava/util/List;Lgcl;)V
    :try_end_0
    .catch Lklk; {:try_start_0 .. :try_end_0} :catch_1

    .line 65
    invoke-interface/range {p8 .. p8}, Lkix;->close()V
    ...
    invoke-interface {v2, v3}, Lkjq;->a(Ljava/lang/String;)V
    :try_end_1
    .catch Lklk; {:try_start_1 .. :try_end_1} :catch_8
    .catch Ljava/lang/InterruptedException; {:try_start_1 .. :try_end_1} :catch_2
    ...
    .line 68
    :try_start_2
    invoke-direct/range {v2 .. v8}, Lejh;->a(Lcom;IILgee;Ljava/util/HashMap;[Landroid/hardware/camera2/params/Face;)Lkxf;
    :try_end_2
    .catch Lklk; {:try_start_2 .. :try_end_2} :catch_3
    ...
    invoke-interface {v0, v2}, Lhzz;->a(Lkxc;)V
    :try_end_3
    ...
    .line 94
    :try_start_5
    invoke-direct {p0, p1, v4, v5, v9}, Lejh;->a(Lcom;IILkxf;)V
    ...
    invoke-interface {v2, p1}, Lcnj;->c(Lcom;)Z
    ...
    invoke-interface {v2, v3}, Lkjl;->c(Ljava/lang/String;)V
    :try_end_5
    .catch Lklk; {:try_start_5 .. :try_end_5} :catch_7
    ...
    invoke-interface {v2, p1}, Lcnj;->b(Lcom;)Z
    ...
    invoke-interface {v2, v3}, Lkjl;->d(Ljava/lang/String;)V
    :try_end_6
    .catch Lklk; {:try_start_6 .. :try_end_6} :catch_7
    ...
    invoke-interface {v2, v3}, Lkjl;->d(Ljava/lang/String;)V
    :try_end_7
    .catch Lklk; {:try_start_7 .. :try_end_7} :catch_7
    ...
    invoke-direct {p0, v0, v10}, Lejh;->a(Lgee;I)Ljava/util/HashMap;
    :try_end_8
    .catch Lklk; {:try_start_8 .. :try_end_8} :catch_8
    ...
    :cond_10
    :try_start_9
    iget-object v4, p0, Lejh;->f:Lkjq;

    const-string v6, "HdrPlus#recoverPayload"

    invoke-interface {v4, v6}, Lkjq;->b(Ljava/lang/String;)V

    .line 106
    iget-object v4, p0, Lejh;->d:Lkjl;
    ...
    .line 108
    invoke-interface {v4, v6}, Lkjl;->f(Ljava/lang/String;)V
    ...
    :cond_16
    :try_start_c
    invoke-direct {p0, p1, v2, v5, v3}, Lejh;->a(Lcom;IILkxf;)V
    :try_end_c
...
.method final a(Lcom;Lcom/google/googlex/gcam/BurstSpec;Lgoe;Lgce;Lgfw;Lmfr;Lgba;Lkix;Lhzz;Lele;)Z
    .locals 13
    ...
    invoke-static {v0, v3}, Lgdf;->a(Lgfw;I)Lgee;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 16
    invoke-static {v2, v3}, Lgdf;->a(Lgfw;I)Lgee;
    :try_end_1
    ...
    .line 21
    :try_start_3
    invoke-static {v2, v8}, Lejh;->a(Ljava/lang/Throwable;Lgee;)V
    :try_end_3
    ...
    :try_start_4
    invoke-static {v2, v7}, Lejh;->a(Ljava/lang/Throwable;Lgee;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    invoke-interface {v2, p1, p2}, Lcnj;->a(Lcom;Lcom/google/googlex/gcam/BurstSpec;)V
    ...
    invoke-direct/range {v2 .. v12}, Lejh;->a(Lcom;Lcom/google/googlex/gcam/FrameRequestVector;Lgoe;Lgce;Lgee;Lgee;Lgba;Lkix;Lhzz;[Landroid/hardware/camera2/params/Face;)Z
    :try_end_5
    ...
    .line 26
    :try_start_6
    invoke-static {v3, v8}, Lejh;->a(Ljava/lang/Throwable;Lgee;)V
    :try_end_6
    ...
    :try_start_7
    invoke-static {v3, v7}, Lejh;->a(Ljava/lang/Throwable;Lgee;)V
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_0
