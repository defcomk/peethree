...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Ljhv;->c:Z

    sput-boolean v1, Ljhv;->d:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ljhv;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ljhv;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Ljhv;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static c(Landroid/content/Context;)I
    ...
    :cond_0
    invoke-static {p0}, Ljsu;->a(Landroid/content/Context;)Z

    move-result v3

    if-nez v3, :cond_b

    sget-object v3, Ljsu;->a:Ljava/lang/Boolean;
    ...
    sput-object v3, Ljsu;->a:Ljava/lang/Boolean;
    ...
    sget-object v4, Ljkz;->a:[Ljkw;

    invoke-static {v3, v4}, Ljhw;->a(Landroid/content/pm/PackageInfo;[Ljkw;)Ljkw;

    move-result-object v3

    if-eqz v3, :cond_7

    new-array v4, v1, [Ljkw;

    aput-object v3, v4, v2

    invoke-static {v6, v4}, Ljhw;->a(Landroid/content/pm/PackageInfo;[Ljkw;)Ljkw;
    ...
    invoke-static {v6, v3}, Ljhw;->a(Landroid/content/pm/PackageInfo;[Ljkw;)Ljkw;
    ...
    :cond_c
    sget-object v3, Ljhv;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Ljko;->a(Landroid/content/Context;)I
...
.method public static d(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, p0}, Ljoa;->a(Landroid/content/Context;)Ljnz;
    ...
    invoke-virtual {v2, v3, v4}, Ljnz;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v2, v3}, Ljhw;->a(Landroid/content/pm/PackageInfo;[Ljkw;)Ljkw;
