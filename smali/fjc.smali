...
.method static constructor <clinit>()V
    ...
    .line 118
    sget-object v1, Lfjc;->a:Ljava/lang/String;
...
.method public static a(Lza;)Ljava/lang/String;
    ...
    invoke-static {v2, v3, v0}, Lbxd;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static a(Lfje;Z)Ljava/util/List;
    .locals 9
    ...
    .line 99
    :goto_0
    iget-object v2, p0, Lfje;->a:Ljava/io/InputStream;
    ...
    .line 100
    :try_start_1
    invoke-virtual {p0}, Lfje;->close()V
    :try_end_1
    ...
    iget-object v3, p0, Lfje;->a:Ljava/io/InputStream;

    invoke-virtual {v3}, Ljava/io/InputStream;->read()I

    move-result v3

    iget-object v4, p0, Lfje;->a:Ljava/io/InputStream;
    ...
    .line 104
    iget-object v5, p0, Lfje;->a:Ljava/io/InputStream;
    ...
    invoke-direct {v5, v4, v2, v3}, Lfjd;-><init>([BII)V
    ...
    invoke-direct {v4, v3, v2, v5}, Lfjd;-><init>([BII)V
...
.method private static a(Ljava/util/List;Lza;)Ljava/util/List;
    ...
    invoke-direct {v5, v1, v7, v2}, Lfjd;-><init>([BII)V
    ...
    invoke-static {v1}, Lfjc;->a(Lfjd;)Z
...
.method public static a(Ljava/io/InputStream;)Lza;
    ...
    invoke-direct {v0, p0}, Lfje;-><init>(Ljava/io/InputStream;)V

    const/4 v1, 0x1

    invoke-static {v0, v1}, Lfjc;->a(Lfje;Z)Ljava/util/List;
    ...
    .line 13
    sget-object v0, Lfjc;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v0}, Lfjc;->a(Ljava/util/List;)Lza;
...
.method public static a(Ljava/lang/String;)Lza;
    ...
    .line 4
    :try_start_1
    invoke-static {v2}, Lfjc;->a(Ljava/io/InputStream;)Lza;
    :try_end_1
    ...
    .line 5
    :try_start_2
    invoke-static {v3, v2}, Lfjc;->a(Ljava/lang/Throwable;Ljava/io/FileInputStream;)V
    :try_end_2
    ...
    .line 6
    sget-object v3, Lfjc;->a:Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v3, v0, v2}, Lbxd;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 11
    :try_start_4
    invoke-static {v0, v2}, Lfjc;->a(Ljava/lang/Throwable;Ljava/io/FileInputStream;)V
...
.method private static a(Ljava/util/List;)Lza;
    ...
    .line 16
    invoke-static {v0}, Lfjc;->a(Lfjd;)Z
    ...
    invoke-static {v1, v3, v0}, Lbxd;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static a(Lfjd;)Z
    .locals 6
...
.method public static a(Ljava/io/InputStream;Ljava/io/OutputStream;Lza;)Z
    ...
    invoke-static {v0, p1, p2}, Lfjc;->a(Ljava/util/List;Ljava/io/OutputStream;Lza;)Z
...
.method public static a(Ljava/lang/String;Lza;)Z
    ...
    invoke-direct {v0, v3}, Lfje;-><init>(Ljava/io/InputStream;)V

    const/4 v4, 0x0

    invoke-static {v0, v4}, Lfjc;->a(Lfje;Z)Ljava/util/List;

    move-result-object v0

    .line 32
    invoke-static {v0, p1}, Lfjc;->a(Ljava/util/List;Lza;)Ljava/util/List;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 33
    :try_start_2
    invoke-static {v0, v3}, Lfjc;->a(Ljava/lang/Throwable;Ljava/io/FileInputStream;)V
    :try_end_2
    .catch Ljava/io/FileNotFoundException; {:try_start_2 .. :try_end_2} :catch_0
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_1
    ...
    .line 35
    :try_start_4
    invoke-static {v0, v4}, Lfjc;->a(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_4
    ...
    :goto_5
    invoke-static {v4, v0, v3}, Lbxd;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_9
...
.method private static a(Ljava/util/List;Ljava/io/OutputStream;Lza;)Z
    ...
    .line 49
    invoke-static {p0, p2}, Lfjc;->a(Ljava/util/List;Lza;)Ljava/util/List;
    ...
    .line 50
    :try_start_0
    invoke-static {p1, v1}, Lfjc;->a(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
