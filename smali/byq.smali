...
# direct methods
.method public constructor <init>(Landroid/hardware/camera2/CameraManager;Lkkh;Ljava/util/concurrent/Executor;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lbyq;->d:Landroid/hardware/camera2/CameraManager;

    .line 3
    iput-object p2, p0, Lbyq;->c:Lkkh;

    .line 4
    iput-object p3, p0, Lbyq;->e:Ljava/util/concurrent/Executor;
    ...
    iput-object v0, p0, Lbyq;->a:Ljava/lang/Object;

    return-void
.end method

.method private final c()Lnbp;
    .locals 3

    .prologue
    .line 10
    iget-object v1, p0, Lbyq;->a:Ljava/lang/Object;

    monitor-enter v1

    .line 11
    :try_start_0
    iget-object v0, p0, Lbyq;->b:Lncf;
    ...
    iput-object v0, p0, Lbyq;->b:Lncf;

    const/4 v0, 0x1

    .line 13
    :goto_0
    iget-object v2, p0, Lbyq;->b:Lncf;
    ...
    .line 15
    iget-object v0, p0, Lbyq;->e:Ljava/util/concurrent/Executor;
...
.method public final a()Lnbp;
    ...
    .line 6
    :try_start_0
    iget-object v0, p0, Lbyq;->d:Landroid/hardware/camera2/CameraManager;
...
.method final b()Z
    ...
    invoke-direct {v0, v4}, Lbys;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 21
    :try_start_2
    iget-object v1, p0, Lbyq;->d:Landroid/hardware/camera2/CameraManager;

    const-string v6, "PollUntilReconnect"

    .line 22
    invoke-static {v5, v6}, Lkbi;->a(Lkbl;Ljava/lang/String;)Landroid/os/Handler;
    ...
    .line 25
    iget-object v1, p0, Lbyq;->c:Lkkh;

    const/4 v2, 0x2

    invoke-interface {v1, v2}, Lkkh;->c(I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_7

    .line 26
    :try_start_3
    invoke-virtual {v5}, Lkbl;->close()V
    :try_end_3
    ...
    :cond_1
    :try_start_4
    iget-object v6, p0, Lbyq;->d:Landroid/hardware/camera2/CameraManager;
    ...
    invoke-interface {v1, v4}, Lkkh;->c(I)V
    :try_end_4
    ...
    .line 36
    iget-object v0, p0, Lbyq;->c:Lkkh;

    const/4 v2, 0x3

    invoke-interface {v0, v2}, Lkkh;->c(I)V
    :try_end_6
    ...
    iget-object v2, p0, Lbyq;->d:Landroid/hardware/camera2/CameraManager;
    ...
    invoke-static {v1, v4}, Lncp;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_9
