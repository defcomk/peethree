...
# direct methods
.method constructor <init>(Ljig;Lcom/google/android/gms/feedback/FeedbackOptions;Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    .locals 0

    iput-object p2, p0, Ljmo;->d:Lcom/google/android/gms/feedback/FeedbackOptions;

    iput-object p3, p0, Ljmo;->a:Landroid/os/Bundle;

    iput-wide p4, p0, Ljmo;->b:J

    iput-object p6, p0, Ljmo;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;

    invoke-direct {p0, p1}, Ljmr;-><init>(Ljig;)V
...
.method protected final a(Ljmt;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Ljmo;->d:Lcom/google/android/gms/feedback/FeedbackOptions;

    iget-object v1, p0, Ljmo;->a:Landroid/os/Bundle;

    iget-wide v2, p0, Ljmo;->b:J

    iget-object v4, p0, Ljmo;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;

    new-instance v5, Ljmp;

    invoke-direct {v5, p0}, Ljmp;-><init>(Ljmo;)V
    ...
    :goto_2
    invoke-interface {v5}, Ljmf;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v0}, Ljmo;->c(Lcom/google/android/gms/common/api/Status;)V
