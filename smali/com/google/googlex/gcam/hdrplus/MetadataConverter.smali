...
# instance fields
.field public final characteristics:Lktr;

.field public final deviceProperties:Lkwm;
...
.method public constructor <init>(Lktr;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lktr;

    .line 3
    sget-object v0, Landroid/hardware/camera2/CameraCharacteristics;->SENSOR_INFO_SENSITIVITY_RANGE:Landroid/hardware/camera2/CameraCharacteristics$Key;

    .line 4
    invoke-interface {p1, v0}, Lktr;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->deviceProperties:Lkwm;

    .line 14
    iget-object v0, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->deviceProperties:Lkwm;
...
.method public static convertToColorSpaceTransform([F)Landroid/hardware/camera2/params/ColorSpaceTransform;
    ...
    invoke-static {v0, v2, v5}, Lmft;->a(ZLjava/lang/String;I)V
...
.method public static convertToGcamStaticMetadata(Lktr;)Lcom/google/googlex/gcam/StaticMetadata;
    .locals 10
    ...
    .line 78
    invoke-interface {p0}, Lktr;->b()Lkuj;

    move-result-object v0

    .line 79
    invoke-static {v0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->convertToLensFacing(Lkuj;)I
    ...
    invoke-static {v1, v6}, Lmft;->a(ZLjava/lang/Object;)V
    ...
    .line 145
    invoke-static {p0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getQcColorCalibration(Lktr;)Lcom/google/googlex/gcam/QcColorCalibration;
    ...
    .line 170
    invoke-static {p0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getReadoutTimeNs(Lktr;)J
...
.method private static convertToLensFacing(Lkuj;)I
    .locals 1
...
.method private getAnalogAndDigitalGain(Lkxc;)[F
    .locals 5
...
.method private static getAwbGains(Lkxc;[I)[F
    .locals 5
    ...
    invoke-interface {p0, v0}, Lkxc;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
...
.method private static getAwbRgb2Rgb(Lkxc;)[F
    .locals 4
...
.method private static getExposureTimeMs(Lkxc;)F
    .locals 2
...
.method public static getGcamRawFormat(Lktr;)Lkuv;
    .locals 7
    ...
    .line 21
    invoke-interface {p0, v5}, Lktr;->a(I)Ljava/util/List;

    move-result-object v1

    .line 22
    invoke-interface {p0, v6}, Lktr;->a(I)Ljava/util/List;

    move-result-object v2

    .line 23
    invoke-interface {p0, v4}, Lktr;->a(I)Ljava/util/List;
    ...
    invoke-direct {v0, v5, v1}, Lkuv;-><init>(ILkiz;)V
    ...
    invoke-static {v2}, Ljzk;->a(Ljava/util/List;)Lkiz;

    move-result-object v1

    invoke-direct {v0, v6, v1}, Lkuv;-><init>(ILkiz;)V
    ...
    invoke-direct {v0, v4, v1}, Lkuv;-><init>(ILkiz;)V
...
.method public static getGcamSensorId(Lktr;)I
    .locals 6
...
.method private static getOisMetadata(Lkxc;)Ljava/util/Optional;
    .locals 1

    .prologue
    .line 301
    invoke-static {p0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->oisMetadataFromCamera2(Lkxc;)Ljava/util/Optional;
...
.method private static getQcColorCalibration(Lktr;)Lcom/google/googlex/gcam/QcColorCalibration;
    .locals 8
    ...
    .line 474
    :try_start_0
    sget-object v0, Ljgn;->A:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :cond_1
    :try_start_1
    sget-object v0, Ljgn;->B:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    .line 486
    sget-object v1, Ljgn;->y:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    .line 498
    sget-object v0, Ljgn;->z:Landroid/hardware/camera2/CameraCharacteristics$Key;
...
.method public static getReadoutTimeNs(Lktr;)J
    .locals 2
    ...
    .line 34
    invoke-interface {p0, v1, v0}, Lktr;->a(ILkiz;)J
...
.method private static oisMetadataFromCamera2(Lkxc;)Ljava/util/Optional;
    .locals 10
    ...
    invoke-interface {p0, v1}, Lkxc;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
...
.method private static oisMetadataFromExperimental(Lkxc;)Ljava/util/Optional;
    .locals 6

    .prologue
    .line 318
    sget-object v0, Ljgn;->r:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    .line 322
    sget-object v1, Ljgn;->w:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    .line 323
    sget-object v2, Ljgn;->s:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-interface {p0, v2}, Lkxc;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    .line 325
    sget-object v3, Ljgn;->t:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p0, v3}, Lkxc;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    .line 329
    :cond_4
    sget-object v2, Ljgn;->u:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    .line 331
    sget-object v3, Ljgn;->v:Landroid/hardware/camera2/CaptureResult$Key;
...
.method public static updateFaceInfo(Lktr;Lcom/google/googlex/gcam/hdrplus/MetadataConverter$ExtendedFaces;Lcom/google/googlex/gcam/FaceInfoVector;)V
    .locals 17
    ...
    invoke-interface {v0, v1}, Lktr;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public convertToGcamFrameMetadata(Lkxc;)Lcom/google/googlex/gcam/FrameMetadata;
    .locals 1
    ...
    .line 177
    invoke-virtual {p0, p1, v0, v0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->convertToGcamFrameMetadata(Lkxc;[Landroid/hardware/camera2/params/Face;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
...
.method public convertToGcamFrameMetadata(Lkxc;[Landroid/hardware/camera2/params/Face;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
    .locals 10
    ...
    .line 179
    iget-object v0, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lktr;

    invoke-static {v0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getGcamSensorId(Lktr;)I
    ...
    .line 180
    invoke-static {p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getExposureTimeMs(Lkxc;)F
    ...
    .line 181
    invoke-direct {p0, p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAnalogAndDigitalGain(Lkxc;)[F
    ...
    .line 191
    invoke-virtual {p0, p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAwbInfoCaptured(Lkxc;)Lcom/google/googlex/gcam/AwbInfo;
    ...
    invoke-direct {v0, p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter$ExtendedFaces;-><init>(Lkxc;)V
    ...
    .line 205
    :cond_3
    iget-object v1, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lktr;

    invoke-virtual {v4}, Lcom/google/googlex/gcam/FrameMetadata;->getFaces()Lcom/google/googlex/gcam/FaceInfoVector;

    move-result-object v3

    invoke-static {v1, v0, v3}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->updateFaceInfo(Lktr;Lcom/google/googlex/gcam/hdrplus/MetadataConverter$ExtendedFaces;Lcom/google/googlex/gcam/FaceInfoVector;)V
    ...
    .line 221
    invoke-interface {v1, v2}, Lktr;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    .line 255
    :cond_b
    invoke-static {p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getOisMetadata(Lkxc;)Ljava/util/Optional;
    ...
    .line 256
    sget-object v0, Ljgn;->c:Landroid/hardware/camera2/CaptureResult$Key;
...
.method public convertToSpatialGainMap(Lkxc;)Lcom/google/googlex/gcam/SpatialGainMap;
    .locals 11
    ...
    .line 412
    invoke-interface {v1, v4}, Lktr;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public getAwbInfoCaptured(Lkxc;)Lcom/google/googlex/gcam/AwbInfo;
    .locals 2
    ...
    invoke-static {p1, v1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAwbGains(Lkxc;[I)[F
    ...
    .line 289
    invoke-static {p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAwbRgb2Rgb(Lkxc;)[F
...
.method public getTotalExposureTime(Lkxc;)F
    .locals 3
...
.method public updateAeShotParams(Lcom/google/googlex/gcam/AeShotParams;Landroid/graphics/Rect;[Landroid/hardware/camera2/params/MeteringRectangle;Lkiz;)V
    .locals 2

    .prologue
    .line 425
    invoke-static {p4}, Lkig;->a(Lkiz;)Lkig;

    move-result-object v0

    .line 426
    invoke-virtual {v0, p2}, Lkig;->a(Landroid/graphics/Rect;)Landroid/graphics/Rect;
...
.method public updateFromFrameRequest(Lcom/google/googlex/gcam/FrameRequest;Lkmx;)V
    .locals 10
    ...
    invoke-virtual {p2, v3, v4}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
    ...
    invoke-virtual {p2, v3, v5}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
    ...
    invoke-virtual {p2, v0, v3}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
    ...
    invoke-virtual {p2, v3, v0}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
    ...
    invoke-virtual {p2, v1, v0}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;

    .line 47
    sget-object v0, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AWB_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-virtual {p2, v0, v5}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
    ...
    invoke-virtual {p2, v1, v2}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
    ...
    invoke-virtual {p2, v0, v4}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
    ...
    invoke-virtual {p2, v0, v1}, Lkmx;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lkmx;
