.class public Lcom/google/android/libraries/smartburst/filterfw/filterpacks/image/BrightnessFilter;
.super Lcom/google/android/libraries/smartburst/filterfw/Filter;
.source "PG"


# static fields
.field public static final mBrightnessShader:Ljava/lang/String; = "precision mediump float;\nuniform sampler2D tex_sampler_0;\nuniform float brightness;\nvarying vec2 v_texcoord;\nvoid main() {\n  vec4 color = texture2D(tex_sampler_0, v_texcoord);\n  if (brightness < 0.5) {\n    gl_FragColor = color * (2.0 * brightness);\n  } else {\n    vec4 diff = 1.0 - color;\n    gl_FragColor = color + diff * (2.0 * (brightness - 0.5));\n  }\n}\n"
...
.method public constructor <init>(Lcom/google/android/libraries/smartburst/filterfw/MffContext;Ljava/lang/String;)V
    ...
    .line 2
    iput v0, p0, Lcom/google/android/libraries/smartburst/filterfw/filterpacks/image/BrightnessFilter;->mBrightness:F
...
.method protected onPrepare()V
    ...
    iput-object v0, p0, Lcom/google/android/libraries/smartburst/filterfw/filterpacks/image/BrightnessFilter;->mShader:Lcom/google/android/libraries/smartburst/filterfw/ImageShader;
...
.method protected onProcess()V
    ...
    .line 14
    invoke-virtual {p0, v0}, Lcom/google/android/libraries/smartburst/filterfw/filterpacks/image/BrightnessFilter;->getConnectedOutputPort(Ljava/lang/String;)Lcom/google/android/libraries/smartburst/filterfw/OutputPort;
    ...
    .line 15
    invoke-virtual {p0, v1}, Lcom/google/android/libraries/smartburst/filterfw/filterpacks/image/BrightnessFilter;->getConnectedInputPort(Ljava/lang/String;)Lcom/google/android/libraries/smartburst/filterfw/InputPort;
    ...
    .line 18
    iget-object v3, p0, Lcom/google/android/libraries/smartburst/filterfw/filterpacks/image/BrightnessFilter;->mShader:Lcom/google/android/libraries/smartburst/filterfw/ImageShader;

    const-string v4, "brightness"

    iget v5, p0, Lcom/google/android/libraries/smartburst/filterfw/filterpacks/image/BrightnessFilter;->mBrightness:F
