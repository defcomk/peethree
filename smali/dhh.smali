...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ldhh;->d:Landroid/view/GestureDetector$SimpleOnGestureListener;

    .line 3
    new-instance v0, Ldhj;

    invoke-direct {v0, p0}, Ldhj;-><init>(Ldhh;)V

    iput-object v0, p0, Ldhh;->c:Landroid/view/GestureDetector$OnDoubleTapListener;

    .line 4
    new-instance v0, Ldhk;

    invoke-direct {v0, p0}, Ldhk;-><init>(Ldhh;)V

    iput-object v0, p0, Ldhh;->e:Landroid/view/ScaleGestureDetector$SimpleOnScaleGestureListener;
    ...
    iget-object v1, p0, Ldhh;->d:Landroid/view/GestureDetector$SimpleOnGestureListener;
    ...
    iput-object v0, p0, Ldhh;->b:Landroid/view/GestureDetector;

    .line 7
    iget-object v0, p0, Ldhh;->b:Landroid/view/GestureDetector;

    iget-object v1, p0, Ldhh;->c:Landroid/view/GestureDetector$OnDoubleTapListener;
    ...
    iget-object v1, p0, Ldhh;->e:Landroid/view/ScaleGestureDetector$SimpleOnScaleGestureListener;

    invoke-direct {v0, p1, v1}, Landroid/view/ScaleGestureDetector;-><init>(Landroid/content/Context;Landroid/view/ScaleGestureDetector$OnScaleGestureListener;)V

    iput-object v0, p0, Ldhh;->f:Landroid/view/ScaleGestureDetector;

    .line 9
    iget-object v0, p0, Ldhh;->f:Landroid/view/ScaleGestureDetector;
...
.method public final a(Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {v0, v1, v2}, Ldhg;->b(FF)Z
