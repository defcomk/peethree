...
# direct methods
.method public constructor <init>(Landroid/hardware/SensorManager;Lkjl;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lkvj;->c:Landroid/hardware/SensorManager;
    ...
    iput-object v0, p0, Lkvj;->d:Ljava/util/Set;

    const/4 v0, 0x0

    .line 5
    iput-object v0, p0, Lkvj;->a:Lkvl;
...
.method private final declared-synchronized a()V
    ...
    .line 6
    :try_start_0
    iget-object v0, p0, Lkvj;->a:Lkvl;

    if-eqz v0, :cond_0

    .line 7
    iget-object v0, p0, Lkvj;->b:Lkjl;
    ...
    invoke-direct {v1, v0}, Lkwa;-><init>(Landroid/hardware/HardwareBuffer;)V

    .line 10
    new-instance v2, Lkvn;

    invoke-direct {v2, v1}, Lkvn;-><init>(Lkwa;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 11
    :try_start_2
    iget-object v3, p0, Lkvj;->c:Landroid/hardware/SensorManager;
    ...
    invoke-direct {v4, v1, v0, v3, v2}, Lkvl;-><init>(Lkwa;Landroid/hardware/SensorDirectChannel;Landroid/hardware/Sensor;Lkvn;)V

    iput-object v4, p0, Lkvj;->a:Lkvl;
...
.method private final declared-synchronized b()V
    ...
    .line 21
    iget-object v1, v0, Lkvl;->a:Landroid/hardware/SensorDirectChannel;

    iget-object v2, v0, Lkvl;->d:Landroid/hardware/Sensor;
    ...
    .line 25
    iget-object v0, v0, Lkvl;->c:Lkwa;

    .line 26
    iget-object v0, v0, Lkwa;->a:Landroid/hardware/HardwareBuffer;
...
.method public final declared-synchronized a(Ljava/lang/String;)Lkvs;
    ...
    .line 29
    :try_start_0
    iget-object v0, p0, Lkvj;->d:Ljava/util/Set;
    ...
    .line 30
    invoke-direct {p0}, Lkvj;->a()V

    .line 31
    :cond_0
    new-instance v0, Lkvk;

    invoke-direct {v0, p0, p1}, Lkvk;-><init>(Lkvj;Ljava/lang/String;)V

    .line 32
    iget-object v1, p0, Lkvj;->d:Ljava/util/Set;

    invoke-interface {v1, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    .line 33
    iget-object v2, p0, Lkvj;->b:Lkjl;

    invoke-interface {v0}, Lkvs;->a()Ljava/lang/String;
...
.method final declared-synchronized a(Lkvs;)V
    ...
    invoke-interface {p1}, Lkvs;->a()Ljava/lang/String;
